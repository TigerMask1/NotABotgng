...
// ��Ǔ�� CONSTANTS ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
...
// ��Ǔ�� ITEM CATALOGUE ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
interface ItemDef {
  name: string;
  emoji: string;
  value: number;
...
const ITEMS: Record<string, ItemDef> = {
  mystery_box:    { name: 'Mystery Box',     emoji: 'a���', value: 0,      rarity: 'common',    description: 'Open with !open box' },
  rusty_coin:     { name: 'Rusty Coin',      emoji: 'a���', value: 10,     rarity: 'common' },
  trade_license:  { name: 'Trade License',   emoji: 'a���', value: 2_000,  rarity: 'rare',   shopPrice: 3_500, description: 'Reduces forge cost by 25%' },
  golden_rolex:   { name: 'Golden Rolex',    emoji: '���', value: 5_000,  rarity: 'epic' },
  ceo_title:      { name: 'CEO Title',       emoji: 'a���', value: 10_000, rarity: 'legendary' },
  lucky_charm:    { name: 'Lucky Charm',     emoji: 'a���', value: 1_500,  rarity: 'rare',   shopPrice: 2_500, description: '+10% coinflip win chance' },
  diamond:        { name: 'Diamond',         emoji: 'a���', value: 8_000,  rarity: 'epic' },
  vault_key:      { name: 'Vault Key',       emoji: 'a���)U�', value: 3_000,  rarity: 'rare',   shopPrice: 5_000, description: 'Open the Vault for bonus loot' },
  nuke:           { name: 'Nuke',            emoji: 'a���', value: 500,    rarity: 'rare',   shopPrice: 1_000, description: 'Rob with +20% success chance' },
  piggy_bank:     { name: 'Piggy Bank',      emoji: 'a��V', value: 750,    rarity: 'common', shopPrice: 1_000, description: '+50% bank interest rate' },
  hacker_kit:     { name: 'Hacker Kit',      emoji: 'a��W', value: 1_200,  rarity: 'rare',   shopPrice: 2_000, description: 'Double !daily once' },
  golden_ticket:  { name: 'Golden Ticket',   emoji: 'a�Ē)U�', value: 500,    rarity: 'common' },
  crystal_ball:   { name: 'Crystal Ball',    emoji: 'a���', value: 4_000,  rarity: 'epic',   shopPrice: 6_000, description: 'Reveal stock trends before investing' },
};

// ��Ǔ�� STOCK MARKET ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
interface Stock {
  name: string;
  emoji: string;
  price: number;
...
const STOCKS: Record<string, Stock> = {
  BOTC: { name: 'BotCoin Industries', emoji: 'a���', price: 100, trend: 0.3,  volatility: 0.15 },
  CLOD: { name: 'Cloud Corp',         emoji: '���)U�', price: 250, trend: -0.1, volatility: 0.22 },
  GRLX: { name: 'Golden Rolex Ltd',   emoji: '���', price: 500, trend: 0.2,  volatility: 0.18 },
  MBOX: { name: 'Mystery Box Corp',   emoji: 'a���', price: 75,  trend: 0.0,  volatility: 0.30 },
  NUKE: { name: 'Nuke Holdings',      emoji: 'a���', price: 175, trend: 0.1,  volatility: 0.28 },
};
...
// ��Ǔ�� IN-MEMORY STATE ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
...
// ��Ǔ�� SCHEMA ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
interface UserData {
  username:    string;
  botcoin:     number;
  netWorth:    number;
...
// ��Ǔ�� HELPERS ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
...
function rarityBadge(r: string): string {
  return { common: '��� Common', rare: 'a��a Rare', epic: 'a��� Epic', legendary: 'a��� Legendary' }[r] || r;
}

// ��Ǔ�� BOT LIFECYCLE ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
export async function startBusinessBot(token: string) {
  ...
  botClient.on(Events.ClientReady, () => {
    ...
    botClient!.user!.setPresence({ status: 'online', activities: [{ name: 'a��� the free market', type: 3 }] });
  });
...
// ��Ǔ�� COMMAND ROUTER ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
async function handleCommand(msg: Message, command: string, args: string[]) {
  ...
  if (userData.jailUntil > Date.now() && !JAIL_FREE.has(command)) {
    ...
    msg.reply(`a��� You're in jail! ${mins} minute(s) left. You can't do that in here.`);
    return;
  }

  switch (command) {

    // ��Ǔ�� ONBOARDING ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'start':
    case 'grant': {
      if (userData.granted) {
      ...
      const embed = new EmbedBuilder()
        .setColor(0x2ecc71)
        .setTitle('a�Ū Central Bank ��� Starter Grant')
        .setDescription(`Welcome to the **Free Market**, ${username}!\nYou've been issued a��� **${STARTER_GRANT.toLocaleString()} Botcoin** by the Central Bank.`)
        .addFields(
          { name: 'a��� Next Steps', value: '`!daily` ��� Claim daily reward\n`!help` ��� See all commands\n`!stocks` ��� Check the market' }
        )
    ...
    // ��Ǔ�� DAILY ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'daily': {
      const now    = Date.now();
      ...
      const embed = new EmbedBuilder()
        .setColor(0xf1c40f)
        .setTitle(`a��� Daily Reward ��� Day ${streak} Streak!`)
        .addFields(
          { name: 'a�Ƒ Daily',    value: `a��� ${dailyAmt.toLocaleString()}`,  inline: true },
          { name: 'a��� Interest', value: `a��� ${interest.toLocaleString()}`,  inline: true },
          { name: streak >= 7 ? 'a��� Streak Bonus' : '��� Streak', value: `a��� ${streakBonus.toLocaleString()} (day ${streak})`, inline: true },
        )
        .setDescription(`You also got a **Mystery Box a���**! Use \`!open box\` to see what's inside.\n${bonus > 0 ? 'a���)U� **Hacker Kit** doubled your daily!' : ''}`)
        .setFooter({ text: `Balance: a��� ${userData.botcoin.toLocaleString()} | New worth: a��� ${userData.netWorth.toLocaleString()}` });
      msg.reply({ embeds: [embed] });
      break;
    }

    // ��Ǔ�� OPEN BOX ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'open': {
      ...
      if (roll < 0.005) {           // 0.5% Jackpot
        ...
        reward = `a�� **MEGA JACKPOT!!!** a��\n+a��� **${amt.toLocaleString()} Botcoin**`;
        color  = 0xf1c40f;
        addXP(userData, 500);
        ...
        userData.botcoin += amt;
        reward = `You found a��� **${amt.toLocaleString()} Botcoin** in the box.`;
        color  = 0x2ecc71;
        addXP(userData, 20);
      } else {                      // 10% Trash
        userData.inventory['rusty_coin'] = (userData.inventory['rusty_coin'] || 0) + 1;
        reward = `You found a a��� **Rusty Coin**. Congratulations on your suffering.`;
        addXP(userData, 5);
      }
      ...
      const embed = new EmbedBuilder()
        .setColor(color)
        .setTitle('a��� Opening Mystery Box...')
        .setDescription(reward)
        .setFooter({ text: `Balance: a��� ${userData.botcoin.toLocaleString()} | Boxes left: ${userData.inventory['mystery_box'] || 0}` });
      msg.reply({ embeds: [embed] });
      break;
    }

    // ��Ǔ�� VAULT ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'vault': {
      if (!userData.inventory['vault_key'] || userData.inventory['vault_key'] <= 0) {
        msg.reply('��� You need a a���)U� **Vault Key** to open the vault. Buy one from `!shop` or find one in a box!');
        return;
      }
      ...
      addXP(userData, 100);
      await saveUser(userId, userData);
      msg.reply(`a���)U� The vault door swings open... you grabbed a��� **${loot.toLocaleString()} Botcoin**!${extra}`);
      break;
    }

    // ��Ǔ�� SLOTS ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'slots': {
      const bet = parseInt(args[0], 10);
      if (isNaN(bet) || bet <= 0) { msg.reply('Usage: `!slots <amount>`'); return; }
      if (bet > userData.botcoin)  { msg.reply(`��� You only have a��� ${userData.botcoin.toLocaleString()}.`); return; }
      if (bet > 10_000)            { msg.reply('��� Max bet is a��� 10,000.'); return; }

      const symbols = ['a���', 'a���', 'a���', 'a���', 'a���', '���', 'a�đ', '7)Uœ��'];
      ...
      if (reels[0] === reels[1] && reels[1] === reels[2]) {
        const multipliers: Record<string, number> = { '7)Uœ��': 20, 'a�đ': 15, '���': 10, 'a���': 8, 'a���': 7, 'a���': 4, 'a���': 3, 'a���': 2 };
        const mult = multipliers[reels[0]] || 2;
        winAmt = bet * mult;
        winMsg = mult >= 10 ? `a��� **JACKPOT!** ${mult}x = a��� **${winAmt.toLocaleString()}**!` : `��� **Triple ${reels[0]}!** ${mult}x = a��� **${winAmt.toLocaleString()}**`;
        userData.wins++;
      } else if (reels[0] === reels[1] || reels[1] === reels[2] || reels[0] === reels[2]) {
        winAmt = Math.floor(bet * 0.5);
        winMsg = `Pair! You get back a��� **${winAmt.toLocaleString()}**`;
      } else {
        winMsg = `No match. You lost a��� **${bet.toLocaleString()}**.`;
        userData.losses++;
      }
      ...
      const embed = new EmbedBuilder()
        ...
        .setTitle('a�đ Slot Machine')
        .setDescription(`**${reels.join('  |  ')}**\n\n${winMsg}`)
        .setFooter({ text: `Balance: a��� ${userData.botcoin.toLocaleString()}` });
      msg.reply({ embeds: [embed] });
      break;
    }

    // ��Ǔ�� ROB ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'rob': {
      ...
      if (success) {
        ...
        msg.reply(`a�Ƒ **ROB SUCCESS!** You swiped a��� **${stolen.toLocaleString()}** from <@${targetId}>!${hasNuke ? ' (Nuke used a���)' : ''}`);
      } else {
        ...
        addXP(userData, 10);
        await saveUser(userId, userData);
        msg.reply(`a��� **CAUGHT!** You got arrested robbing <@${targetId}>. Paid a��� **${fine.toLocaleString()}** fine and you're in jail for **30 minutes**. Use \`!profile\` to see your sentence.`);
      }
      break;
    }

    // ��Ǔ�� WAGER (COINFLIP) ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'wager':
    case 'flip': {
      ...
      if (amount > userData.botcoin)    { msg.reply(`��� You only have a��� ${userData.botcoin.toLocaleString()}.`); return; }
      if (targetId === userId)          { msg.reply("��� Can't wager against yourself."); return; }
      if (amount > 50_000)              { msg.reply('��� Max wager is a��� 50,000.'); return; }
      ...
      const embed = new EmbedBuilder()
        .setColor(0xffff00)
        .setTitle('a�ē Coinflip Challenge!')
        .setDescription(`<@${targetId}>, **${username}** challenged you to a 50/50 coinflip for a��� **${amount.toLocaleString()}**!\n\nType \`!accept @${username}\` to accept, or just ignore it.`)
    ...
    // ��Ǔ�� ACCEPT (WAGER) ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'accept': {
      ...
      if (userData.botcoin < wager.amount) { msg.reply(`��� You need a��� ${wager.amount.toLocaleString()} to accept.`); return; }
      ...
      if (!challengerData || challengerData.botcoin < wager.amount) {
        msg.reply("��� Challenger no longer has enough a���!");
      ...
      const embed = new EmbedBuilder()
        .setColor(0xf1c40f)
        .setTitle('a�ē Coinflip Result')
        .setDescription(`a��� The coin spins...\n\na��� **<@${winnerId}> wins a��� ${wager.amount.toLocaleString()}** from <@${loserId}>!${hasLucky ? '\na��� (Lucky Charm activated!)' : ''}`)
        .setFooter({ text: `Winner balance: a��� ${winner.botcoin.toLocaleString()}` });
      msg.reply({ embeds: [embed] });
      break;
    }

    // ��Ǔ�� CHALLENGE (1v1) ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'challenge': {
      ...
      if (!targetData || targetData.botcoin < amount) {
        msg.reply(`��� <@${targetId}> doesn't have enough a��� to match!`); return;
      }
      ...
      const embed = new EmbedBuilder()
        .setColor(0xe67e22)
        .setTitle(`���)U� Challenge Issued ��� [${challengeId}]`)
        .setDescription(`<@${targetId}>, **${username}** has challenged you!\n\n**Terms:** *${terms}*\n**Pot:** a��� ${(amount * 2).toLocaleString()} total (a��� ${amount.toLocaleString()} each side)`)
    ...
    // ��Ǔ�� YIELD ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'yield': {
      ...
      if (userId === challenge.toId) {
        if (userData.botcoin < challenge.amount) { msg.reply("��� Not enough a��� to pay!"); return; }
      ...
      msg.reply(`a��)U� **YIELD!** <@${userId}> surrenders! <@${winnerId}> wins the a��� **${(challenge.amount * 2).toLocaleString()}** pot!`);
      break;
    }

    // ��Ǔ�� AWARD CHALLENGE ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'award': {
      const challengeId  = args[0]?.toUpperCase();
      ...
      if (loserId === challenge.toId) {
        if (loserData.botcoin < challenge.amount) { msg.reply(`��� <@${loserId}> doesn't have enough a���!`); return; }
      ...
      await saveUser(winnerId, winnerData);
      activeChallenges.delete(challengeId);
      msg.reply(`a��� **Challenge [${challengeId}] settled!** <@${winnerId}> wins a��� **${(challenge.amount * 2).toLocaleString()}**!`);
      break;
    }

    // ��Ǔ�� PAY ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'pay': {
      const targetMatch = args[0]?.match(/<@!?(\d+)>/);
      const amount      = parseInt(args[1], 10);
      ...
      if (amount > userData.botcoin) { msg.reply(`��� Not enough a���. Balance: ${userData.botcoin.toLocaleString()}`); return; }
      ...
      msg.reply(`a��U Sent a��� **${amount.toLocaleString()}** to <@${targetId}>!`);
      break;
    }

    // ��Ǔ�� STOCKS ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'stocks':
    case 'market': {
      const embed = new EmbedBuilder()
        .setColor(0x23272a)
        .setTitle('a��� Botcoin Stock Exchange')
      ...
      for (const [sym, s] of Object.entries(STOCKS)) {
        const trendArrow = s.trend > 0.1 ? 'a���' : s.trend < -0.1 ? 'a���' : '���)U�';
        const owned = userData.stocks?.[sym] || 0;
        embed.addFields({
          name: `${s.emoji} ${s.name} [${sym}]`,
          value: `a��� **${s.price.toLocaleString()}**/share   ${trendArrow}${owned > 0 ? `   You own: **${owned}**` : ''}`,
        });
      }
      msg.reply({ embeds: [embed] });
      break;
    ...
    case 'buy': {
      ...
      if (cost > userData.botcoin) { msg.reply(`��� Costs a��� ${cost.toLocaleString()}. You have a��� ${userData.botcoin.toLocaleString()}.`); return; }
      userData.botcoin    -= cost;
      userData.stocks     ??= {};
      userData.stocks[sym] = (userData.stocks[sym] || 0) + shares;
      addXP(userData, 20);
      await saveUser(userId, userData);
      msg.reply(`a��� Bought **${shares}x ${stock.name}** [${sym}] for a��� **${cost.toLocaleString()}**. Avg: ${stock.price}/share.`);
      break;
    }
    ...
    case 'sell': {
      ...
      addXP(userData, 15);
      await saveUser(userId, userData);
      msg.reply(`a��� Sold **${shares}x ${sym}** for a��� **${revenue.toLocaleString()}**.`);
      break;
    }
    ...
    case 'portfolio': {
      const embed = new EmbedBuilder()
        .setColor(0x3498db)
        .setTitle(`a��� ${username}'s Portfolio`);
      let total = 0;
      let hasStocks = false;
      for (const [sym, shares] of Object.entries(userData.stocks || {})) {
        ...
        total += val;
        hasStocks = true;
        embed.addFields({ name: `${s.emoji} ${sym}`, value: `${shares} shares @ a���${s.price} = a��� **${val.toLocaleString()}**`, inline: true });
      }
      if (!hasStocks) embed.setDescription('No stocks owned. Use `!buy <SYMBOL> <shares>` to invest.');
      else embed.setDescription(`Total stock value: a��� **${total.toLocaleString()}**`);
      msg.reply({ embeds: [embed] });
      break;
    }

    // ��Ǔ�� SHOP ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'shop': {
      const shopItems = Object.entries(ITEMS).filter(([, v]) => v.shopPrice);
      const embed = new EmbedBuilder()
        .setColor(0xf1c40f)
        .setTitle('a��� Black Market Shop')
      ...
      for (const [key, item] of shopItems) {
        embed.addFields({
          ...
          value: `a��� **${item.shopPrice!.toLocaleString()}**  ���  ${item.description || ''}`,
        });
      }
      msg.reply({ embeds: [embed] });
      break;
    ...
    case 'buy': {
      ...
      if (userData.botcoin < item.shopPrice) { msg.reply(`��� Costs a��� ${item.shopPrice.toLocaleString()}. You have a��� ${userData.botcoin.toLocaleString()}.`); return; }
      userData.botcoin -= item.shopPrice;
      userData.inventory[itemId] = (userData.inventory[itemId] || 0) + 1;
      addXP(userData, 30);
      await saveUser(userId, userData);
      msg.reply(`a��� Bought ${item.emoji} **${item.name}** for a��� ${item.shopPrice.toLocaleString()}!`);
      break;
    }

    // ��Ǔ�� TRADE ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'trade': {
      ...
      const embed = new EmbedBuilder()
        .setColor(0x1abc9c)
        .setTitle(`a�� Trade Offer ��� [${tradeId}]`)
    ...
    // ��Ǔ�� AUCTION ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'auction': {
      const sub = args.shift()?.toLowerCase();

      if (sub === 'list') {
        if (activeAuctions.size === 0) { msg.reply('a��� No active auctions right now.'); return; }
        const embed = new EmbedBuilder().setColor(0xe67e22).setTitle('a��� Active Auctions');
        for (const [key, a] of activeAuctions) {
          const item    = allItems[a.itemId];
          const secsLeft = Math.max(0, Math.ceil((a.endTime - Date.now()) / 1000));
          embed.addFields({
            name: `${item?.emoji || 'a���'} ${item?.name || a.itemId}`,
            value: `Current: a��� **${a.highestBid.toLocaleString()}** by ${a.highestBidder ? `<@${a.highestBidder}>` : 'nobody'}\nEnds in: **${secsLeft}s**\nBid: \`!auction bid ${key} <amount>\``,
          });
        }
        msg.reply({ embeds: [embed] });
        return;
      ...
      if (sub === 'start') {
        ...
        const embed = new EmbedBuilder()
          .setColor(0xe67e22)
          .setTitle(`a��� Auction Started!`)
          .setDescription(`**${username}** is auctioning ${item?.emoji || 'a���'} **${item?.name || itemId}**!\nStarting bid: a��� **${startBid.toLocaleString()}**`)
        ...
        setTimeout(async () => {
          ...
          if (!a.highestBidder) {
            ...
            (ch as any).send(`a��� Auction ended with no bids ��� ${item?.emoji || ''} **${item?.name || itemId}** returned to <@${a.sellerId}>.`);
          } else {
            ...
            (ch as any).send(`a��� **SOLD!** ${item?.emoji || ''} **${item?.name || itemId}** ��� <@${a.highestBidder}> for a��� **${a.highestBid.toLocaleString()}**!`);
          }
        }, AUCTION_DURATION);
        return;
      }
      ...
      if (sub === 'bid') {
        ...
        if (bidAmt <= a.highestBid)    { msg.reply(`��� Must bid more than a��� ${a.highestBid.toLocaleString()}.`); return; }
        if (bidAmt > userData.botcoin) { msg.reply(`��� Not enough a���.`); return; }
        ...
        const item = allItems[a.itemId];
        const secsLeft = Math.max(0, Math.ceil((a.endTime - Date.now()) / 1000));
        msg.reply(`a��U **${username}** bids a��� **${bidAmt.toLocaleString()}** on ${item?.emoji || ''} **${item?.name || a.itemId}**! (${secsLeft}s left)`);
        return;
      }
    ...
    // ��Ǔ�� BOUNTY ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'bounty': {
      const sub = args.shift()?.toLowerCase();

      if (sub === 'list') {
        const bounties = globalState.bounties || {};
        const embed = new EmbedBuilder().setColor(0xff0000).setTitle('a��� WANTED: Bounty Board');
        let any = false;
        for (const [id, b] of Object.entries(bounties)) {
          const bty = b as any;
          if (bty.status !== 'open') continue;
          embed.addFields({ name: `[${id}] a��� ${bty.amount.toLocaleString()}`, value: `${bty.task}\n��� posted by ${bty.posterName}` });
          any = true;
        }
      ...
      if (sub === 'post') {
        ...
        if (userData.botcoin < amount) { msg.reply("��� Not enough a���."); return; }
        userData.botcoin -= amount;
        ...
        msg.reply(`a��� **Bounty [${bountyId}] Posted!** a��� **${amount.toLocaleString()}** locked up.\nTask: *${task}*`);
        return;
      }
      ...
      if (sub === 'award') {
        ...
        msg.reply(`a�Ƒ **BOUNTY CLAIMED!** <@${targetId}> awarded a��� **${bty.amount.toLocaleString()}** for: *${bty.task}*`);
        return;
      }
    ...
    // ��Ǔ�� FORGE ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'forge': {
      if (args.length < 2) { msg.reply(`Usage: \`!forge <emoji> <Name>\`\nCost: a��� **${FORGE_COST}**`); return; }
      const hasLicense = (userData.inventory['trade_license'] || 0) > 0;
      const cost       = hasLicense ? Math.floor(FORGE_COST * 0.75) : FORGE_COST;
      if (userData.botcoin < cost) { msg.reply(`��� Need a��� **${cost}** to forge.${hasLicense ? '' : '\na��� Tip: A Trade License reduces forge cost by 25%!'}`); return; }
      const emoji  = args[0];
      ...
      const embed = new EmbedBuilder()
        .setColor(0xe67e22)
        .setTitle('���)U� Item Forged!')
        .setDescription(`${emoji} **${name}** has been permanently injected into the global economy!\na��� Cost: **${cost.toLocaleString()}**${hasLicense ? ' *(Trade License discount applied!)*' : ''}`)
        .setFooter({ text: `Item ID: ${itemId}` });
      msg.reply({ embeds: [embed] });
      break;
    }

    // ��Ǔ�� INVENTORY ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'inventory':
    case 'inv': {
      const embed = new EmbedBuilder()
        .setColor(0x9b59b6)
        .setTitle(`a��� ${username}'s Inventory`);
      let hasItems = false;
      for (const [key, count] of Object.entries(userData.inventory || {})) {
        ...
        embed.addFields({
          ...
          value: `${rarityBadge(item.rarity || 'common')}  ���  a��� ${(item.value * (count as number)).toLocaleString()} total value\n${item.description ? `*${item.description}*` : ''}  \`[${key}]\``,
        });
        hasItems = true;
      }
    ...
    // ��Ǔ�� PROFILE ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'profile':
    case 'bal': {
      ...
      const embed = new EmbedBuilder()
        ...
        .setTitle(`a��� ${username}  ���  ${levelLabel(lvl)} (Lv.${lvl})`)
        .addFields(
          { name: 'a�Ƒ Botcoin',    value: `a��� ${userData.botcoin.toLocaleString()}`,             inline: true },
          { name: 'a��� Net Worth',  value: `a��� ${(userData.netWorth || 0).toLocaleString()}`,     inline: true },
          { name: 'a��� Rank',       value: `#${rank} globally`,                                   inline: true },
          { name: 'a�ē W/L',        value: `${userData.wins || 0}W / ${userData.losses || 0}L`,   inline: true },
          { name: 'a��U Earned',     value: `a��� ${(userData.totalEarned || 0).toLocaleString()}`,   inline: true },
          { name: 'a��� Streak',     value: `${userData.dailyStreak || 0} days`,                   inline: true },
        )
        .setFooter({ text: `XP: ${userData.xp || 0} / ${xpForLevel(lvl)} ��� next level${userData.jailUntil > Date.now() ? ` | a��� In jail ${Math.ceil((userData.jailUntil - Date.now())/60000)}m` : ''}` });
      msg.reply({ embeds: [embed] });
      break;
    }

    // ��Ǔ�� LEADERBOARD ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'leaderboard':
    case 'lb':
    case 'rich': {
      const topSnap = await db.collection('businessUsers').orderBy('netWorth', 'desc').limit(10).get();
      const medals  = ['a���', 'a���', 'a���', '4)Uœ��', '5)Uœ��', '6)Uœ��', '7)Uœ��', '8)Uœ��', '9)Uœ��', 'a���'];
      const embed   = new EmbedBuilder()
        .setColor(0xf1c40f)
        .setTitle('a��� Global Forbes List ��� Top Net Worth');
      topSnap.docs.forEach((doc, i) => {
        const d = doc.data();
        embed.addFields({
          name: `${medals[i]} ${d.username}  (Lv.${d.level || 1} ${levelLabel(d.level || 1)})`,
          value: `a��� **${(d.netWorth || 0).toLocaleString()}** net worth`,
        });
      });
      msg.reply({ embeds: [embed] });
      break;
    ...
    // ��Ǔ�� HELP ��Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ�Ǔ��
    case 'bhelp':
    case 'help': {
...
Name: ${username}
Botcoin Balance: a��� ${userData.botcoin}
